...
class FlowModel(BaseModel):
    ...
    """
    def __init__(self, num_nodes, num_vars, num_layers, hid_dim, num_params, nonlin="leaky-relu",
                 intervention=False, intervention_type="perfect",
                 intervention_knowledge="known", num_regimes=1):
        super().__init__(num_nodes, num_vars, num_layers, hid_dim, num_params, nonlin=nonlin,
...
class DeepSigmoidalFlowModel(FlowModel):
    def __init__(self, num_nodes, num_vars, cond_n_layers, cond_hid_dim, cond_nonlin, flow_n_layers, flow_hid_dim,
                 intervention=False, intervention_type="perfect",
                 intervention_knowledge="known", num_regimes=1):
        """
        Deep Sigmoidal Flow model

        :param int num_nodes: number of nodes    # lpw add
        ...
        super().__init__(num_nodes, num_vars, cond_n_layers, cond_hid_dim, num_params=n_conditioned_params, nonlin=cond_nonlin,
                         intervention=intervention,
                         intervention_type=intervention_type,
                         intervention_knowledge=intervention_knowledge,
                         num_regimes=num_regimes)
