...
if __name__ == "__main__":
    ...
    parser.add_argument('--nb-dag', type=int, default=3,#10
                        help='Number of DAGs to generate dataset from')
    parser.add_argument('--nb-points', type=int, default=100,#1000
    ...
    parser.add_argument('--intervention', action='store_true', default=True,
    ...
    parser.add_argument('--obs-data', action='store_true', default=True,
